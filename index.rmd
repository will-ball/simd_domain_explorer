...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, rank_decile) %>%
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, inc_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, emp_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, hlth_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, edu_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
         "Income Decile" = "edu_rank_decile",
         "Overall Decile" = "rank_decile") %>% 
  DT::datatable(rownames = F, options = list(pageLength = 10))
```   
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, g_acc_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, crime_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
...
sf_datazones %>% 
  st_drop_geometry() %>% 
  select(dz_name, la_name, house_rank_decile, rank_decile) %>%
  rename("Datazone" = "dz_name",
         "Council Area" = "la_name",
